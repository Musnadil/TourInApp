...
import com.indexdev.tourin.databinding.ItemAllTourBinding

class AllListTourAdapter(private val onClickItem: OnclickListener) :
    RecyclerView.Adapter<AllListTourAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(private val binding: ItemAllTourBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        return ViewHolder(ItemAllTourBinding.inflate(inflater,parent,false))
    }
